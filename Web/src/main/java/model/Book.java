...
public class Book {
    ...
    public Book(int id, String model, String title, String author, double price, double priceDiscounted, String type, int age, String coverImgUrl, String description, String publisher, String provider, LocalDate publishedDate, double weight, String bookSize, int pagesNumber, String format, boolean isSell, Date add_date, int quantitySell) {
        this.id = id;
        this.model = model;
        this.title = title;
        this.author = author;
